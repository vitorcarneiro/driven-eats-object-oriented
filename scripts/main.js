...
const pratosItems = [];
pratos.forEach((prato) => pratosItems.push(new Item(prato)));
pratosItems.forEach((prato) => pratosContainer.appendChild(getPratoView(prato)));

const bebidasItems = [];
bebidas.forEach((prato) => bebidasItems.push(new Item(prato)));
const bebidasContainer = document.querySelector(".opcoes.bebida");
bebidasItems.forEach((bebida) =>
  bebidasContainer.appendChild(getBebidaView(bebida))
);

const sobremesasItems = [];
sobremesas.forEach((prato) => sobremesasItems.push(new Item(prato)));
const sobremesasContainer = document.querySelector(".opcoes.sobremesa");
sobremesasItems.forEach((sobremesa) =>
